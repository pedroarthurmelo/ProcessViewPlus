function imprimirGraficoRosca() {
    // Obter o canvas do gráfico
    const canvas = document.getElementById('roscaChartCanvas');
    if (!canvas) {
    ...
    janelaImpressao.document.write(`
        ...
        <head>
            <meta charset="UTF-8">
            <title>Imprimir Gráfico de Rosca</title>
            <style>
                body {
        ...
        <body>
            <img src="${imagemGrafico}" alt="Gráfico de Rosca">
            <script>
