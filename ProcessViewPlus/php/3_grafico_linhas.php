...
if (!isset($_POST['variaveis_selecionadas']) || empty($_POST['variaveis_selecionadas'])) {
...
// Validação e processamento de cada variável
foreach ($variaveis_selecionadas as $variavel) {
    // Verificar se o formato da variável está correto
